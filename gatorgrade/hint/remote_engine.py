...
class RemoteHintEngine:
    ...
    def __init__(
        self,
        base_url: str,
        api_key_env: str = REMOTE_KEY_ENV_DEFAULT,
        ...
        self._api_key = self._get_env_val_from_var(api_key_env)
    ...
    def _get_env_val_from_var(env_variable: str) -> str | None:
        """Return value for environemnt variable.
    ...
    def generate_hint(  # noqa: PLR0913
        ...
        if not self._api_key:
            ...
            # TODO: consider adding EXPORT instrucitons here
            return None, False
